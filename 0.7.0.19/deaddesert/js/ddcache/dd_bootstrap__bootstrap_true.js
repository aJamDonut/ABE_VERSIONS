...
bootStrap.push(function () {
  ...
  function showZones() {
    cleanup();
    if (!game.grid.chunkTree["region_0_0.json"].meta || !game.grid.chunkTree["region_0_0.json"].meta.zones) return;
    let polygons = game.grid.chunkTree["region_0_0.json"].meta.zones;
  ...
  function commit() {
    if (!game.grid.chunkTree["region_0_0.json"].meta) {
      game.grid.chunkTree["region_0_0.json"].meta = {};
    }
    const meta = game.grid.chunkTree["region_0_0.json"].meta;
    if (!meta.zones) {
      meta.zones = [];
    }
    meta.zones.push({
