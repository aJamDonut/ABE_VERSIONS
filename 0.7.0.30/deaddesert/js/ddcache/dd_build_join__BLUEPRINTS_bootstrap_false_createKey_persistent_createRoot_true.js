(function () {
  ...
  _BLUEPRINTS.persistent.spawn_player = {
    "sprite": 'btn_blank_sqr',
    "meta": {},
    "events": {
      "onCreate": function (spawner) {
        ...
        try {
          player.inventory.brain.addItem(new InventoryItem('ss_brain_player_mk1'), true);
          player.inventory.mask.addItem(new InventoryItem('ss_mask_happymask'), true);
    ...
    "events": {
      "onCreate": function (furni) {
        ...
        for (var codename in _BLUEPRINTS.INV_ITEMS) {
          furni.inventory.slowAddItem(new InventoryItem(codename), true);
        }
      }
    },
    "parent": 'build_world_lootcontainers',
  ...
  _BLUEPRINTS.persistent.asdasdasd = {
    "meta": {},
    "events": {},
    "parent": 'build_world_npcspawners',
    "name": 'sadsadsad'
  };
})();