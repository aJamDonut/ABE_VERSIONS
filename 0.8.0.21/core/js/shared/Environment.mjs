...
function isLive() {
	...
	if(urlVar && typeof urlVar['isLive'] === "undefined") return true; //No keys can be read at all, assume live (github pages)

	if(!Object.keys(urlVar).length) return true; //No keys can be read at all, assume live (github pages)
