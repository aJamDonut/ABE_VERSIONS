(function () {
  ...
  _BLUEPRINTS.COMPONENTS.hud_main = {
    "getElement": function () {
      ...
      game.setTicker('position_hud', () => {
        ...
        charCard2.x = game.ui._VIEWPORT_RIGHT - charCard2.width;
  ...
  _BLUEPRINTS.COMPONENTS.advanced_particles_4 = {
    "getElement": function (options) {
      ...
      scroller.sprite.filters = [new ABE.PIXI.filters.AdvancedBloomFilter({
        threshold: 0.0,
        bloomScale: 2.8,
        brightness: 0.1,
        blur: 6,
  ...
  _BLUEPRINTS.COMPONENTS.advanced_elec_boom_masked = {
    "getElement": function (options) {
      ...
      rectangle.tint = 0xFF0000;
      const blurSize = 15;
      rectangle.filters = [new PIXI.filters.BlurFilter(blurSize)];
      rectangle.x = 25;
      rectangle.y = 50;
  ...
  _BLUEPRINTS.COMPONENTS.hud_settings_preferences = {
    "getElement": function () {
      ...
      var pane = new UIContainer();
      container.addChild(pane);
      let barsCounter = game.render.component('hud_bars_counter', {
      ...
      barsCounter.x = volume.x + volume.width + 10;
      barsCounter.y = volume.y + (volume.height - barsCounter.height) / 2;
  ...
  _BLUEPRINTS.COMPONENTS.hud_stat_bars = {
    ...
    "getElement": function (options) {
      ...
      for (let stat of stats) {
        ...
        statBar.x = 10;
        statBar.y = offsetY;
        offsetY += statBar.height + padding;
  ...
  _BLUEPRINTS.COMPONENTS.hud_player_card_new = {
    ...
    "getElement": function (options) {
      ...
      const stats = game.render.componentRaw('hud_stat_bars', {
        player: options.player.data.isPlayer
      });
      stats.x = 5;
      stats.y = 5;
      pane.addChild(stats);
  ...
  _BLUEPRINTS.COMPONENTS.statBar = {
    "getElement": function (options) {
      ...
      options.name = typeof options.name === 'undefined' ? 'HP' : options.name;
  ...
  _BLUEPRINTS.COMPONENTS.component_stat_bar = {
    "getElement": function (options) {
      ...
      var stat = new TickerContainer(options, function () {
        ...
        if (this.stat) {
          return this.stat.updateVal(value, max);
        }
        this.stat = game.render.componentRaw('statBar', {
          callerObject: watch,
          valueKey: key,
        ...
        return this.addChild(this.stat);
      }, ticker, true);
    ...
    "getElement": function (options) {
      ...
      if (options.showBar) {
        var barsCounter = game.render.component('hud_bars_counter', {
          ...
          orientation: 'horizontal',
          barWidth: (pane.width - space * 10) / 10,
          barHeight: h - 10,
          barCount: 10,
          barSpacing: space,
