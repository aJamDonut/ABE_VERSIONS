  ...
  _BLUEPRINTS.DIALOGS.dialog_sicks_questgiver = {
    ...
    "option2_func": function (caller, player) {
      if (!game.getFlag('barrel-flag')) {
        ...
        game.getFlag('colleague-flag');
        game.setFlag('colleague-flag', true);
        return "If you could deliver this barrel of the good stuff up to my colleague in Drumley, I'd pay you handsomely.";
      }
      return "Hey buddy! I have no work right now because you're supposed to be delivering that barrel.";
    },
